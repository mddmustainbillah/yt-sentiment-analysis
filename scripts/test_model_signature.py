...
def test_model_with_vectorizer(model_name, stage, vectorizer_path):
    ...
    try:
        ...
        # Check that predictions are in expected range (adjust based on your actual classes)
        valid_predictions = all(isinstance(pred, (int, float)) for pred in predictions)
